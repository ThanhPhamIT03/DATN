<section id="category-slide" class="py-4" style="background-color: var(--bgr-gray);">
    <div class="container">
        <div class="row gx-3 gy-4 justify-content-center category-slide">
            ...
            <div class="col-6 col-md-3">
                <div class="category-item position-relative overflow-hidden rounded shadow-sm" onclick="location.href='#'" style="cursor: pointer;">
                    <img src="{{ asset('./images/may-tinh-bang-3-800x450.jpg') }}" alt="Điện thoại" class="w-100 h-100 object-cover">
            ...
            <div class="col-6 col-md-3">
                <div class="category-item position-relative overflow-hidden rounded shadow-sm" onclick="location.href='#'" style="cursor: pointer;">
                    <img src="{{ asset('./images/phu-kien-dien-thoai-gia-si-1.jpg') }}" alt="Điện thoại" class="w-100 h-100 object-cover">
            ...
            <div class="col-6 col-md-3">
                <div class="category-item position-relative overflow-hidden rounded shadow-sm" onclick="location.href='#'" style="cursor: pointer;">
                    <img src="{{ asset('./images/Anh-thumb-9-768x402.jpg') }}" alt="Điện thoại" class="w-100 h-100 object-cover">
