<section>
    <div class="container-xl p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="m-0 fearture-phone-heading" data-aos="fade-right" data-aos-duration="1000">Máy tính bảng nổi bật</h4>
            <ul class="product-list" data-aos="fade-left" data-aos-duration="1000">
                ...
                @endforeach
                <li>
                    <a href="{{ route('web.product-category.index', $categoryTabletId) }}">Xem tất cả</a>
                </li>
            </ul>
        </div>
