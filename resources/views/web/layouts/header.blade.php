        ...
        <div class="container-xl header-nav d-flex align-items-center justify-content-between">
            ...
            <div class="header-menu d-flex align-items-center justify-content-between">
                ...
                <div class="category-block {{ $isCartPage ? 'd-none' : '' }}">
                    <ul>
                        <li><a href="#"><i class="bi bi-phone"></i>Điện thoại<i class="bi bi-chevron-right last-icon"></i></a></li>
                        <li><a href="#"><i class="bi bi-tablet"></i>Máy tính bảng<i class="bi bi-chevron-right last-icon"></i></a></li>
                        <li><a href="#"><i class="bi bi-usb-plug"></i>Phụ kiện<i class="bi bi-chevron-right last-icon"></i></a></li>
                        <li><a href="#"><i class="bi bi-phone-flip"></i>Hàng cũ<i class="bi bi-chevron-right last-icon"></i></a></li>
                        <li><a href="#"><i class="bi bi-file-earmark-post"></i>Tin công nghệ<i class="bi bi-chevron-right last-icon"></i></a></li>
                        <li><a href="#"><i class="bi bi-megaphone"></i>Khuyến mãi<i class="bi bi-chevron-right last-icon"></i></a></li>
                        <li><a href="#"><i class="bi bi-phone-flip"></i>Thu cũ đổi mới<i class="bi bi-chevron-right last-icon"></i></a></li>
                    </ul>
                </div>
